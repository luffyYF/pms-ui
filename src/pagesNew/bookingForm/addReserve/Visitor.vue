...
<script>
    ...
    import reserveManager from '@/pages/bookingForm/addReserve/reserveManager'
    import chooseGuest from '@/pages/bookingForm/addReserve/chooseGuest'
    ...
    export default {
      ...
      methods: {
        ...
        endDateChange(endDate) {
          if( (this.currFormType=='guest-info' && this.form.orderStatus=='CHECKIN') || (this.form.roomPk && this.form.orderStatus=='RESERVE')){
