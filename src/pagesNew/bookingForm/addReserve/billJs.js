  ...
  // 组件
  import dialogBorrow from '@/pages/bookingForm/addReserve/dialogBorrow'
  ...
  // import dialogAdvanceCheckoutRemind from '@/pages/bookingForm/addReserve/bill/dialogAdvanceCheckoutRemind'
