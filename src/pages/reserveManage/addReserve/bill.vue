    ...
    <el-row>
      <el-col :span="15">
        ...
        <el-col :span="24" class="bill-el-button">
          结账处理：
          <el-button size="mini" @click="settlement(0)" v-if="powerJudge('402010') && (currOrderInfo.order.orderStatus=='LEAVE' || currOrderInfo.order.orderStatus=='CHECKIN' || currOrderInfo.order.orderStatus=='LEAVENOPAY')" >结账</el-button>
      ...
      <div class="pattern-dialog-container" style="padding: 25px 4px;">
        <el-form ref="formAddBill" :model="formAddBill" size="mini" label-width="80px">
          ...
          <el-form-item label="渠道类型" required v-if="formAddBill.payment=='5'">
            ...
            <channel-select v-model="formAddBill.channelTypePk" style="width:100%"></channel-select>   
          </el-form-item>
