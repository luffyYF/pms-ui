...
.newReserveOrder .el-dialog__header{
    color: white;
    background-color: #F60;
    padding: 10px;
}
.newReserveOrder .el-dialog__body{
    padding: 0 0px;
}
.newReserveOrder .el-dialog__title{
    color: white;
    font-size: 15px;
    line-height: 15px;
}
.newReserveOrder .el-dialog__headerbtn .el-dialog__close{
  color: white;
}
.newReserveOrder .el-dialog__headerbtn{
    top: 10px;
    right: 10px;
}
.newReserveOrder .el-table .cell{
  font-size: 12px;
  padding: 0;
}
</style>
