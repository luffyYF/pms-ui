            ...
            <el-dropdown trigger="click" class="pattern-dropdown" :hide-on-click="true">
              ...
              <el-dropdown-menu slot="dropdown" class="pattern-dropdown-li" >
                <el-dropdown-item class="el-dropdown-menu__item" v-if="(item.roomStatus=='CLEAN_CHECKED' 
                                                                      ...
                                                                      && !item.guestOrderPk" ><el-button  type="text" :disabled="!powerJudge('402211')" @click="toCheckin(item)">办理入住</el-button></el-dropdown-item>
                <el-dropdown-item class="el-dropdown-menu__item" v-if="item.guestOrderPk"><el-button  type="text" @click="toDialogVisible(item, 'info')">办理续住</el-button></el-dropdown-item>
                <el-dropdown-item class="el-dropdown-menu__item" v-if="item.guestOrderPk"><el-button  type="text" @click="toDialogVisible(item, 'settle')">结账退房</el-button></el-dropdown-item>
                <el-dropdown-item class="el-dropdown-menu__item" v-if="(item.roomStatus=='CLEAN_NOCHECK'
                                                                      ...
                                                                      || item.roomStatus=='FREE_ROOM') && item.roomStatus!='DIRTY'"><el-button :disabled="!powerJudge('402210')" type="text" @click="changeRoomStatus(item, 'DIRTY', index)">转为脏房</el-button></el-dropdown-item>
                <el-dropdown-item class="el-dropdown-menu__item" v-if="item.roomStatus=='DIRTY'
                                                                      || item.roomStatus=='CLEAN_CHECKED'
                                                                      || item.roomStatus=='OCCUPY'"><el-button  type="text" :disabled="!powerJudge('402201')" @click="changeRoomStatus(item, 'CLEAN_NOCHECK', index)">清洁未检查</el-button></el-dropdown-item>
                <el-dropdown-item class="el-dropdown-menu__item" v-if="item.roomStatus=='DIRTY'
                                                                      || item.roomStatus=='CLEAN_NOCHECK'"><el-button  type="text" :disabled="!powerJudge('402208')" @click="changeRoomStatus(item, 'CLEAN_CHECKED', index)">清洁检查房</el-button></el-dropdown-item>
                <el-dropdown-item class="el-dropdown-menu__item" v-if="(item.roomStatus=='DIRTY'
                                                                      || item.roomStatus=='CLEAN_NOCHECK' 
                                                                      || item.roomStatus=='CLEAN_CHECKED'
                                                                      || item.roomStatus=='SELF_USE'
                                                                      || item.roomStatus=='FREE_ROOM') && !item.guestOrderPk"><el-button type="text" :disabled="!powerJudge('402203')" @click="showRepair(item)">转维修房</el-button></el-dropdown-item>
                <el-dropdown-item class="el-dropdown-menu__item" v-if="(item.roomStatus=='DIRTY'
                                                                      || item.roomStatus=='CLEAN_NOCHECK' 
                                                                      || item.roomStatus=='CLEAN_CHECKED' 
                                                                      || item.roomStatus=='SELF_USE'
                                                                      || item.roomStatus=='FREE_ROOM' ) && !item.guestOrderPk"><el-button :disabled="!powerJudge('402202')" type="text" @click="showDisable(item)">转停用房</el-button></el-dropdown-item>
                <el-dropdown-item class="el-dropdown-menu__item" v-if="item.roomStatus=='REPAIR_ROOM'"><el-button  type="text" :disabled="!powerJudge('402206')" @click="seeRoomReason(item, 'REPAIR')">查看维修房</el-button></el-dropdown-item>
                <el-dropdown-item class="el-dropdown-menu__item" v-if="item.roomStatus=='DISABLE_ROOM'"><el-button  type="text" :disabled="!powerJudge('402204')" @click="seeRoomReason(item, 'DISABLE')">查看停用房</el-button></el-dropdown-item>
                <el-dropdown-item class="el-dropdown-menu__item" v-if="item.roomStatus=='REPAIR_ROOM'"><el-button  type="text" :disabled="!powerJudge('402207')" @click="finshRoomReason(item,'REPAIR')">结束维修</el-button></el-dropdown-item>
                <el-dropdown-item class="el-dropdown-menu__item" v-if="item.roomStatus=='DISABLE_ROOM'"><el-button  type="text" :disabled="!powerJudge('402205')" @click="finshRoomReason(item,'DISABLE')">结束停用</el-button></el-dropdown-item>
                <el-dropdown-item class="el-dropdown-menu__item" v-if="item.orderPk"><el-button type="text" @click="toDialogVisible(item, 'info')">查看订单信息</el-button></el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </div>
          <!-- 房间item end -->
