  ...
  <div class="bg-server">
    <el-form ref="form" :inline="true" :model="form1" size="mini" label-width="80px">
      <el-form-item label="留言状态">
        <el-select v-model="form.region" placeholder="请选择留言状态">
          <el-option label="未读取" value="shanghai"></el-option>
          <el-option label="已读取" value="beijing"></el-option>
        </el-select>
      </el-form-item>
    ...
    <el-table :data="goodsList" v-loading="loading" height="300" border style="width: 100%" empty-text="未查到当前有留言" @row-dblclick="cellClickHandle">												
      ...
      <el-table-column prop="createTime" align="center"  label="登记时间" width="190"></el-table-column>
