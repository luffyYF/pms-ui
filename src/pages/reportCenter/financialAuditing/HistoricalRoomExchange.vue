    ...
    <el-col :span="24" class="title">
      <div class="demo-input-suffix">
        <el-form ref="form" :model="form">
          换房日期：<el-date-picker v-model="form.datepicker" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" size="mini"></el-date-picker>
    ...
    <el-col :span="24">
      <div class="tabs">
        ...
        <div class="tabs-contetn">
          ...
          <el-table v-loading="loading" :data="tableData | globalFilter(form.datepicker) | globalFilter(form.srcRoomNumber)" border height="200" style="width: 100%; margin-top: 5px">
...
export default {
  data() {
    return {
      form: {
        datepicker: formatDate(new Date(), 'yyyy-MM-dd'),
        srcRoomNumber: ''
      },
