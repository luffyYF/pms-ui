    ...
    <el-col :span="24">
      <div class="tabs">
        <div class="tavs-title" id="print-turnoverofbusinessincome">
          ...
          <h3 style="text-align:center;">各营业点收入日报表</h3>
        </div>
        <el-table
          ...
          <el-table-column type="expand">
            <template slot-scope="scope">
              <el-table
                :header-cell-style="tableStyleObj"
                :cell-style="tableStyleObj"
                :data="subTableData[scope.row.companyPk]"
                border
              >
                <el-table-column
                  width="120"
                  v-for="(v,i) in subHeads[scope.row.companyPk]"
                  :prop="v.code"
                  :label="v.desc"
                  :key="i"
                ></el-table-column>
        ...
        <p style="height:20px;">
          <span class="left">打印人： {{userInfo.realName}}</span>
          <span class="right">打印日期：{{datepickerTime}}</span>
        </p>
        <p class="note_p2"></p>
      </div>
    </el-col>
  ...
  methods: {
    ...
    createOneFormPage() {
      ...
      this.LODOP.ADD_PRINT_TABLE(
        ...
        770,
        903,
        document.getElementById("print-turnoverofbusinessincomeTable").innerHTML
      );
      ...
      this.LODOP.ADD_PRINT_HTM(
        ...
        770,
        80,
        document.getElementById("print-turnoverofbusinessincome").innerHTML
      );
