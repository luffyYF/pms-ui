  ...
  <div class="container">
    ...
    <div class="table-container">
      <div id="print-managerdailyreportTitle">
        ...
        <h3 style="text-align: center">营业月报</h3>
      </div>
      <div class="table-box" id="print-managerdailyreportTable">
        ...
        <thead>
           <tr>
              <th colspan="3" style="text-align: left;font-size: 12px;">店铺：{{activeCompany.companyName}}</th>
          ...
          <tbody>
            ...
            <tr>
             ...
             <tr>
              ...
              <td style="width: 16%;padding: 6px 2px 6px 1px;text-align: right;border: 1px solid #000;font-size: 12px;">{{(((tableMonth.individualRoomNum == null ? 0 : tableMonth.individualRoomNum)+(tableMonth.teamRoomNum == null ? 0 : tableMonth.teamRoomNum))/(tableMonth.totalRoomNum == null ? 0 : tableMonth.totalRoomNum)*100).toFixed(2)}}%</td>
              <td style="width: 16%;padding: 6px 2px 6px 1px;text-align: right;border: 1px solid #000;font-size: 12px;">{{(((tableYear.individualRoomNum == null ? 0 : tableYear.individualRoomNum)+(tableYear.teamRoomNum == null ? 0 : tableYear.teamRoomNum))/(tableYear.totalRoomNum == null ? 1 : tableYear.totalRoomNum)*100).toFixed(2)}}%</td>
            </tr>
...
export default {
  ...
  methods: {
    ...
    createOneFormPage() {
      ...
      this.LODOP.PRINT_INITA(0 , 0, 794, 1123, "营业月报打印");
      this.LODOP.SET_SHOW_MODE("BKIMG_IN_PREVIEW", 1);// 显示背景
