  ...
  },*/
{
  ...
  children:[
    {label:'营业收入日报',path:'/reportCenter/turnoverDaily',pointer:'pms:reportCenter:turnoverDaily'},
    {label:'营业收入月报',path:'/reportCenter/TurnoverMonth',pointer:'pms:reportCenter:turnoverMonth'},
    {label:'营业收入日报明细',path:'/reportCenter/TurnoverDailyDetail',pointer:'pms:reportCenter:tdd'},
    {label:'营业收入明细月报',path:'/reportCenter/TurnoverMonthDetail',pointer:'pms:reportCenter:tmd'},
