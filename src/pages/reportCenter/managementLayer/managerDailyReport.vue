    ...
    <div class="table-container">
      ...
      <div class="table-box" id="print-managerdailyreportTable">
        <table width="100%" border="0" style="border-collapse:collapse;font-family: 宋体;font-size: 12px;margin:0 auto;color:black;text-align: left;" cellpadding="6" cellspacing="0">
          <thead>
            <tr>
              <th colspan="4" style="text-align: left;font-size: 14px;">店铺：{{activeCompany.companyName}}</th>
...
export default {
  ...
  methods: {
    ...
    createOneFormPage() {
      ...
      this.LODOP.ADD_PRINT_TABLE(90,10,770,903,document.getElementById("print-managerdailyreportTable").innerHTML);
      ...
      this.LODOP.ADD_PRINT_HTM(10,10,770,80,document.getElementById("print-managerdailyreportTitle").innerHTML);
