  ...
  <div class="container">
    ...
    <div class="table-container">
      <div id="print-managerdailyreportTitle">
        ...
        <h3 style="text-align: center">经理时间段报表</h3>
      </div>
...
<script>
import {managerDailyTimesReport } from "@/api/reportCenter/pmsReportFormController"
...
export default {
  ...
  methods: {
    ...
    getList(){
      let self = this
      managerDailyTimesReport(this.queryObj).then((res)=>{
        console.log(res)
        if(res.code == 1){
    ...
    //导出EXCEL
    downloadExcel(){
      let url = '/pms/report/managerDailyTimesReportExcel?begin='+this.queryObj.begin+'&end='+this.queryObj.end
      downloadExcel(url, '经理时间段报表');
