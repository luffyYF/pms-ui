  ...
  <section class="plan-list">
    <el-row :gutter="24">
      <el-col :span="18">
        <el-form class="seach-form" ref="listQuery" :inline="true" :model="listQuery" label-width="70px" size="small" label-position="right">
            ...
            <el-form-item>
                <el-button type="primary" size="mini" v-if="hasPerm('pms:roomPrice:batchEdit')" @click="batchEditClick()" icon="el-icon-edit">批量修改</el-button>
            </el-form-item>
        </el-form>
      </el-col>
    </el-row>
    ...
    <el-form ref="settingObj" size="small" :rules="rules" :model="settingObj" label-width="80px">
        ...
        <el-form-item label="房间价格" prop="price">
            <!-- <el-input type="text" v-model="settingObj.price" placeholder="房间价格" size="small" clearable> </el-input> -->
        ...
        <el-form-item label="早餐数量" prop="numberOfBreakfast">
            <!-- <el-input type="text" style="width:300px;" v-model="settingObj.numberOfBreakfast" placeholder="早餐数量" size="small" clearable> </el-input> -->
...
<script>
  ...
  export default {
    ...
    mounted () {
        this.editPower = this.hasPerm('pms:roomPrice:edit')
        this.queryPower = this.hasPerm('pms:roomPrice:list')
        this.roomTypeInit()
        this.listSearch()
    },
    watch:{
    ...
    methods: {
      ...
      cellClick (row, column, cell, event) {
          if(column.property != undefined && column.property.indexOf('column')!=-1 && row.pk && this.editPower){
                ...
                this.settingObj.roomStatus = 2
                // obj == null?2:obj.roomStatus
      ...
      subClick(){
        this.$refs.settingObj.validate(valid => {
            if (valid) {
                ...
                settingPrice(this.settingObj).then(res => {
                    this.dialogVisible = false
                    this.listSearch()
                }).finally(() => {
