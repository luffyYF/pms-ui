...
<style>
.common-message-class .ylDialog{
  bottom: 0;
  width:300px;
  border: 1px solid #F60;
}
.common-message-class .ylDialog .el-dialog__header{
    color: white;
    background-color: #F60;
    padding: 10px;
}
.common-message-class .ylDialog .el-dialog__body{
    padding: 0 0px;
}
.common-message-class .ylDialog .el-dialog__title{
    color: white;
    font-size: 15px;
    line-height: 15px;
}
.common-message-class .ylDialog .el-dialog__headerbtn .el-dialog__close{
  color: white;
}
.common-message-class .ylDialog .el-dialog__headerbtn{
    top: 10px;
    right: 10px;
}
.common-message-class .ylDialog .el-table .cell{
  font-size: 12px;
  padding: 0;
}
</style>
