    ...
    <el-row :gutter="24">
      <el-col :span="18">
        <el-form class="seach-form" ref="listQuery" :inline="true" :model="listQuery" label-width="70px" size="small" label-position="right">
            ...
            <el-form-item>
                <el-button type="primary" size="mini" @click="batchEditClick()" icon="el-icon-edit">批量修改</el-button>
            </el-form-item>
        </el-form>
      </el-col>
    </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      cellClick (row, column, cell, event) {
          if(column.property != undefined && column.property.indexOf('column')!=-1 && row.pk){
                console.log(row);
                console.log(column);
                console.log(cell);
                console.log(event);
